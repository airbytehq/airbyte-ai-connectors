...
from connector_mcp.models import ExecuteResponse, ListEntitiesResponse
from connector_mcp.secret_manager import DotEnvSecretsBackend, SecretsManager

logger = logging.getLogger(__name__)

# Initialize FastMCP server
mcp = FastMCP("connector-mcp")
...
def init_server(config_path: str = "configured_connectors.yaml", dotenv_path: str = ".env"):
    ...
    logger.info("Initializing connector-mcp server...")
