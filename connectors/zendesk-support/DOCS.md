...
|----------------|------|----------|-------------|
| `page` | `integer` | No | Page number for pagination |
| `access` | `enum` | No | Filter by access level |
| `active` | `boolean` | No | Filter by active status |
| `group_id` | `integer` | No | Filter by group ID |
| `sort_by` | `enum` | No | Sort results |
| `sort_order` | `enum` | No | Sort order |
...
|----------------|------|----------|-------------|
| `page` | `integer` | No | Page number for pagination |
| `sort_by` | `enum` | No | Sort articles by field |
| `sort_order` | `enum` | No | Sort order |
